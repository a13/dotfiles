...
function bind_scroll_keys (keymap) {
    ...
    define_key(keymap, "M-м","cmd_scrollPageUp");
    define_key(keymap, "C-м","cmd_scrollPageDown");
    ...
    define_key(keymap, "C-з","cmd_scrollLineUp");
    define_key(keymap, "C-т","cmd_scrollLineDown");
    ...
    define_key(keymap, "C-и","cmd_scrollLeft");
    define_key(keymap, "C-f","cmd_scrollRight");
    define_key(keymap, "C-а","cmd_scrollRight");
    define_key(keymap, "C-a","scroll-beginning-of-line");
    define_key(keymap, "C-ф","scroll-beginning-of-line");
    define_key(keymap, "C-e","scroll-end-of-line");
    define_key(keymap, "C-у","scroll-end-of-line");
    define_key(keymap, "M-<","scroll-top-left");
    define_key(keymap, "M-Б","scroll-top-left");
    define_key(keymap, "M->","cmd_scrollBottom");
    define_key(keymap, "M-Ю","cmd_scrollBottom");
...
function bind_selection_keys (keymap) {
    ...
    define_key(keymap, "M-ц","cmd_copy");
    ...
    define_key(keymap, "C-И", "cmd_selectCharPrevious");
    define_key(keymap, "C-А", "cmd_selectCharNext");
    define_key(keymap, "M-И", "cmd_selectWordPrevious");
    define_key(keymap, "M-А", "cmd_selectWordNext");
    define_key(keymap, "C-З", "cmd_selectLinePrevious");
    define_key(keymap, "C-Т", "cmd_selectLineNext");
}
