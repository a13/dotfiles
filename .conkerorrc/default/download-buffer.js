...
define_key(download_buffer_keymap, "в", "download-cancel");
define_key(download_buffer_keymap, "к", "download-retry-or-resume");
define_key(download_buffer_keymap, "з", "download-pause-or-resume");
define_key(download_buffer_keymap, "C-в", "download-remove");
define_key(download_buffer_keymap, "ч", "download-shell-command");
define_key(download_buffer_keymap, "щ", "download-shell-command");
